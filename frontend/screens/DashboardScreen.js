  ...
  render: async () => {
    ...
    <div class="dashboard-content">
      ...
      <li>
        ...
        <div class="summary-body color2">${summary.users[0].numUsers}
        </div>
      </li>
      <li>
        ...
        <div class="summary-body">${summary.orders[0].numOrders}
        </div>
      </li>
      <li>
        ...
        <div class="summary-body">${summary.orders[0].totalSales}
        </div>
      </li>
      </ul>
      <div class="charts">
